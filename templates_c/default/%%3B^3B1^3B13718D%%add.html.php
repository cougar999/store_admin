<?php /* Smarty version 2.6.26, created on 2013-01-04 16:59:23
									...
									<table width="100%" border="0">
										...
										<tbody>
											...
											<tr>
												...
												<td>&nbsp;</td>
												<td class="padded">
													<textarea id="couponDescription" name="description" style="width:90%;" rows="7" class="textarea_text"></textarea>
												</td>
											</tr>
											<tr>
												<td valign="top" align="right" class="padded">
												...
												<td>&nbsp;</td>
												<td class="padded">
													<textarea id="couponContent" name="content" style="width:90%;height:200px;" rows="7" class="textarea_text"></textarea>
												</td>
											</tr>
											<tr>
												<td valign="top" align="right" class="padded">
											...
											<tr>
												...
												<td>&nbsp;</td>
												<td>
													<input type="text" value="" class="textbox_text" maxlength="255" style="width:120px;" name="start_time" id="start_time"> 开始
													<input type="text" value="" class="textbox_text" maxlength="255" style="width:120px;" name="end_time" id="end_time"> 截止
												</td>
											</tr>
											<tr>
												<td valign="top" align="right" class="padded">
